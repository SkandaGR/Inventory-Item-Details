...
OrgChart.prototype.load = function(t) {
    ...
    "A4" == t.format && "fit" != t.scale || "A3" == t.format && "fit" != t.scale || "A2" == t.format && "fit" != t.scale || "A1" == t.format && "fit" != t.scale ? r(this._pagesA100(t, e, t.scale)) : "A4" == t.format && "fit" == t.scale || "A3" == t.format && "fit" == t.scale || "A2" == t.format && "fit" == t.scale || "A1" == t.format && "fit" == t.scale ? r(this._pagesAfit(t, e)) : "fit" == t.format && r(this._pagesFit(t, e))
    ...
    for (var g = n, p = l, f = d.w * (100 / r), u = d.h * (100 / r), C = []; g < s - 1;) {
        for (; p < h - 1;) {
            var m = [g, p, g + f, u];
            m = m.join(), C.push({
                vb: m,
    ...
    if (this.config.enableDragDrop) {
        ...
        if (!1 !== OrgChart.events.publish("drag", [this, i])) {
            ...
            var v = {
                ...
                w = m.getScale(),
                _ = t.cloneNode(!0);
            if (O.insertBefore(_, O.firstChild), _.style.opacity = .7, l.isChildOfGroup) {
            ...
            var k = function(t, e) {
                    ...
                    if (v) {
                        ...
                        if (a.left || a.right || a.up || a.down) {
                            ...
                            m.startMove(a, function(t) {
                                x[4] = o + t.x, x[5] = n + t.y, v.x = l - t.xWithoutScale, v.y = s - t.yWithoutScale, e.x = h - t.xWithoutScale, e.y = d - t.yWithoutScale, _.setAttribute("transform", "matrix(" + x.toString() + ")")
                            })
                        } else {
                            ...
                            if (null != u) {
                                var g = m.getBGNode(u);
                                g.isChildOfGroup && (m.getNodeElement(g._groupParentNodeId).style.opacity = .8), C.style.opacity = .5
                            }
                            var p = (e.x - v.x) / w,
                                f = (e.y - v.y) / w;
                ...
                h = function(t) {
                    if (m.stopMove(), O.classList.remove("cursor-grab"), O.classList.remove("cursor-move"), O.removeEventListener(n.move, s), O.removeEventListener(n.up, h), n.leave && O.removeEventListener(n.leave, h), l.id == u || l.isChildOfGroup && l._groupParentNodeId == u || null == u) return k(u, C), O.removeChild(_), void(m._gragStartedId = null);
                    var e = m.getBGNode(u);
    ...
    if (t) {
        if (this._movePosition = t, !this._moveInterval) {
            ...
            this._moveInterval = setInterval(function() {
                ...
                r._movePosition.left && (o++, t.x = o * OrgChart.MOVE_STEP / a, t.xWithoutScale = o * OrgChart.MOVE_STEP), r._movePosition.right && (o++, t.x = -o * OrgChart.MOVE_STEP / a, t.xWithoutScale = -o * OrgChart.MOVE_STEP), r._movePosition.up && (n++, t.y = -n * OrgChart.MOVE_STEP / a, t.yWithoutScale = -n * OrgChart.MOVE_STEP), r._movePosition.down && (n++, t.y = n * OrgChart.MOVE_STEP / a, t.yWithoutScale = n * OrgChart.MOVE_STEP), r.setViewBox([i[0] + t.x, i[1] + t.y, i[2], i[3]]), r.xScrollUI.setPosition(), r.yScrollUI.setPosition(), e && e(t)
    ...
    for (c = 0; c < n.length; c++) {
        ...
        t == OrgChart.action.exporting && null != e.id && (l = [o[e.id]]), x ? (v.state = x.state, v.state == OrgChart.COLLAPSE && m.push(v.id), OrgChart.server._setNodeGroupState(v, x.groupState, a.orientation)) : OrgChart.server._setNodeGroupState(v, OrgChart.EXPAND, a.orientation), OrgChart.server._initStates(v, o, t, a, e, m), OrgChart.server._initGroupStates(v, o, t, a, e)
    }
    if (null != a.roots) {
        l = [];
    ...
    for (c = 0; c < s.length; c++) {
        ...
        if (H) {
            ...
            for (b = H.children.length - 1; 0 <= b; b--) {
                (U = H.children[b]).isAssistant ? (U.parent = null, H.children.splice(b, 1), H.childrenIds.splice(b, 1), k.splice(0, 0, U.id)) : (U.pid = _.id, (U.parent = _).children.unshift(U), _.childrenIds.unshift(U.id), H.children.splice(b, 1))
            }
            if (k.length % 2) {
                ...
                OrgChart.templates[A] = {
                    ...
                    nodeMenuButton: "",
                    size: I
                }, (W = new OrgChart.node(H.id + "_transperant", S.pid, [], A)).isAssistant = !0, (x = r[(o[W.id] = W).id]) && (o[W.id].state = x.state, o[W.id].state == OrgChart.COLLAPSE && -1 == m.indexOf(W.id) && m.push(W.id)), k.splice(k.length - 1, 0, W.id), OrgChart.server._initStates(W, o, t, a, e, m)
            }
            var N = 1;
            ...
            for (b = 0; b < k.length; b += 3) {
                ...
                var M = o[k[b]],
                    L = o[k[b + 1]],
                    B = o[k[b + 2]];
                M.parent = E, M.pid = E.id, L.parent = E, L.pid = E.id, B.parent = E, B.pid = E.id, E.children.push(M), E.children.push(L), E.children.push(B), E.childrenIds.push(M.id), E.childrenIds.push(L.id), E.childrenIds.push(B.id);
                for (var T = E;
                    "split" == T.templateName && (T = T.parent);) T.childrenIds.push(M.id), T.childrenIds.push(L.id), T.childrenIds.push(B.id);
            ...
            for (c = 0; c < P.childrenIds.length; c++) {
                if (-1 != (D = m.indexOf(P.childrenIds[c])) && m.splice(D, 1), (U = o[P.childrenIds[c]]).state = OrgChart.EXPAND, !U.isAssistant && !OrgChart.server._isSplit(U))
                    for (b = 0; b < U.childrenIds.length; b++) {
                        var D, G = o[U.childrenIds[b]]; - 1 == (D = m.indexOf(U.childrenIds[b])) && m.push(U.childrenIds[b]), G.state = OrgChart.COLLAPSE
                    }
            }
    }
    ...
    if (a.layout == OrgChart.tree || a.layout == OrgChart.treeRightOffset || a.layout == OrgChart.treeLeftOffset) {
        ...
        for (c = 0; c < q.length; c++) {
            ...
            for (b = H.children.length - 1; 0 <= b; b--) {
                if (OrgChart.server._mixedLayoutAllNodes(H))
                    if (0 == (U = H.children[b]).childrenIds.length && !U.isAssistant && "split" != U.templateName && (U.parent && "split" != U.parent.templateName || U.parent.isAssistant)) {
                        if ((U = H.children[b]).parent = null, U.layout = OrgChart.tree, H.children.splice(b, 1), H.childrenIds.splice(b, 1), a.layout == OrgChart.treeRightOffset && V.splice(0, 0, U.id), a.layout == OrgChart.treeLeftOffset || a.layout == OrgChart.treeRightOffset) {
                            var W;
                            ...
                            OrgChart.templates[A] = {
                                ...
                                nodeMenuButton: "",
                                size: [0, 0]
                            }, (W = new OrgChart.node(U.id + "_transperant", null, [], A)).layout = OrgChart.tree, o[W.id] = W, V.splice(0, 0, W.id)
                        }
            ...
            for (b = 0; b < V.length; b += 3) {
                ...
                0 != b && (E = o[V[b - 3]]), 0 == b || L || (E = o[V[b - 2]]), M.parent = E, M.pid = E.id, E.children.push(M), H.childrenIds.push(M.id), L && (0 != b && (E = o[V[b - 2]]), L.parent = E, L.pid = E.id, E.children.push(L), H.childrenIds.push(L.id)), B && (0 != b && (E = o[V[b - 1]]), B.parent = E, B.pid = E.id, E.children.push(B), H.childrenIds.push(B.id))
            }
        }
    }
    return {
        ...
        if (OrgChart.server._isVisible(A, i, s, d)) {
            ...
            if (d == OrgChart.action.expandCollapse && f && f[A.id] && "expandCollapseToLevel" == c.method) {
                ...
                if (null != (T = f[A.id]).x && null != T.y && (N = {
                        x: T.x,
                        y: T.y
                    }), (B = g[c.id]) && B == A)(E = A.parent) && E.id == c.id && (N = {
                    x: B.x + B.w / 2 - A.w / 2,
                    y: B.y + B.h / 2 - A.h / 2
                })
            ...
            } else if (d == OrgChart.action.insert && c && c.insertedNodeId == A.id) N = {
                x: A.parent.x,
                y: A.parent.y
            };
            ...
            null != N && null != N.x && null != N.y && (N.x == A.x && N.y == A.y || (m[0].push(A.id), m[1].push({
    ...
    expandCollapse: function(t, e, r, i, a) {
        ...
        if (n -= s.expandCollapseSize / 2, l -= s.expandCollapseSize / 2, e.collapsedChildrenIds.length ? (o += OrgChart.expcollOpenTag.replace("{id}", e.id).replace("{x}", n).replace("{y}", l), o += s.plus) : (o += OrgChart.expcollOpenTag.replace("{id}", e.id).replace("{x}", n).replace("{y}", l), o += s.minus), (o += OrgChart.grCloseTag).indexOf("{collapsed-children-count}")) {
...
}, OrgChart.pdfPrevUI = {}, OrgChart.loc || (OrgChart.loc = {}), OrgChart.loc.ppdfCmdTitle = "PDF Preview", OrgChart.loc.ppdfSave = "Save", OrgChart.loc.ppdfCancel = "Cancel", OrgChart.loc.ppdfFormat = "Format", OrgChart.loc.ppdfFitToDrwaing = "Fit", OrgChart.loc.ppdfA4 = "A4", OrgChart.loc.ppdfA3 = "A3", OrgChart.loc.ppdfA2 = "A2", OrgChart.loc.ppdfA1 = "A1", OrgChart.loc.ppdfLayout = "Layout", OrgChart.loc.ppdfPortrait = "Portrait", OrgChart.loc.ppdfLandscape = "Landscape", OrgChart.loc.ppdfFittopagewidth = "Fit to page width", OrgChart.loc.ppdfMargin = "Margin", OrgChart.loc.ppdfHeader = "Header", OrgChart.loc.ppdfFooter = "Footer", OrgChart.loc.ppdfScale = "Scale", OrgChart.pdfPrevUI.show = function(r, i) {
    ...
    "A4" == t.value || "A3" == t.value || "A2" == t.value || "A1" == t.value ? (e.parentNode.style.display = "block", r.parentNode.style.display = "block") : (e.parentNode.style.display = "none", r.parentNode.style.display = "none")
    ...
    for (var r, i, a, o, n, l = "", s = 0; s < this.config.clinks.length; s++) {
        ...
        if ((d.isChildOfGroup || e.res.visibleNodes[d.id]) && ((!d.isChildOfGroup || e.res.visibleNodes[d._groupParentNodeId]) && (c.isChildOfGroup || e.res.visibleNodes[c.id]) && (!c.isChildOfGroup || e.res.visibleNodes[c._groupParentNodeId]))) {
            ...
            var I = (r = O, a = k, void 0, o = ((i = v).x - r.x) / 2 + r.x, n = (i.y - r.y) / 2 + r.y, {
                x: (o - a.x) / 2 + a.x,
                y: (n - a.y) / 2 + a.y
            });
    ...
    function t(t, e, r) {
        ...
        if (t.level == e.level) switch (a = e, _.config.orientation) {
            ...
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
                s.q = t.y + t.h, s.s = A.maxY - l, i.push([s.p, s.q]), i.push([s.r, t.y + t.h + l / 3]), n = OrgChart.t(a.templateName, I), i.push([a.x + a.w / 2 + n.expandCollapseSize, i[i.length - 1][1]]), i.push([i[i.length - 1][0], a.y + a.h]);
                break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
                s.p = t.x, s.q = t.y + t.h / 2 + n.expandCollapseSize, s.r = A.minX - l, s.s = t.y + t.h / 2 + n.expandCollapseSize, i.push([s.p, s.q]), i.push([t.x - l / 3, s.q]), n = OrgChart.t(a.templateName, I), i.push([i[i.length - 1][0], a.y + a.h / 2 + n.expandCollapseSize]), i.push([a.x, i[i.length - 1][1]]);
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                s.p = t.x + t.w, s.q = t.y + t.h / 2 + n.expandCollapseSize, s.r = A.maxX + l, s.s = t.y + t.h / 2 + n.expandCollapseSize, i.push([s.p, s.q]), i.push([t.x + t.w + l / 3, s.q]), n = OrgChart.t(a.templateName, I), i.push([i[i.length - 1][0], a.y + a.h / 2 + n.expandCollapseSize]), i.push([a.x + a.w, i[i.length - 1][1]])
        } else {
            switch (_.config.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
